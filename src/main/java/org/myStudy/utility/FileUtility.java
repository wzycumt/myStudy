...
public class FileUtility {
	...
	private static final ResourceBundle resource = ResourceBundle.getBundle("ftp");
	private static final String host = resource.getString("host"); //FTP服务器地址
	private static final int port = Integer.parseInt(resource.getString("port")); //FTP服务器端口号
	private static final String username = resource.getString("username"); //FTP登录帐号
	private static final String password = resource.getString("password"); //FTP登录密码
	/**
